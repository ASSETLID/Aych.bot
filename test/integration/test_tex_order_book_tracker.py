...
class TEXOrderBookTrackerUnitTest(unittest.TestCase):
    order_book_tracker: Optional[TEXOrderBookTracker] = None
    ...
    def setUpClass(cls):
        ...
        cls.order_book_tracker: TEXOrderBookTracker = TEXOrderBookTracker(
    ...
    def test_tracker_integrity(self):
        ...
        order_book: OrderBook = order_books["fLQD-fETH"]
        self.assertGreaterEqual(order_book.get_price_for_volume(True, 1000).result_price,
                                order_book.get_price(True))
        self.assertLessEqual(order_book.get_price_for_volume(False, 1000).result_price,
                             order_book.get_price(False))
